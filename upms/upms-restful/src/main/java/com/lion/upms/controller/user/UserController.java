...
public class UserController extends BaseControllerImpl implements BaseController {
    ...
    public IPageResultData<List<ListUserVo>> list(@ApiParam(value = "是否本科室") Boolean isMyDepartment, @ApiParam(value = "科室") Long departmentId,@ApiParam(value = "用户类型") Long userTypeId,@ApiParam(value = "员工编号") Integer number,@ApiParam(value = "姓名")  String name,@ApiParam(value = "角色") Long roleId, @ApiParam(value = "是否管理员") Boolean isAdmin,@RequestParam(required = false)  List<Long> ids,LionPage lionPage){
    ...
    public void export(@ApiParam(value = "是否本科室") Boolean isMyDepartment, @ApiParam(value = "科室") Long departmentId,@ApiParam(value = "用户类型") Long userTypeId,@ApiParam(value = "员工编号") Integer number,@ApiParam(value = "姓名")  String name,@ApiParam(value = "角色") Long roleId,@RequestParam(required = false) List<Long> ids,LionPage lionPage) throws IOException, IllegalAccessException {
        if (Objects.equals(isMyDepartment,true)) {
            Department department = departmentUserExposeService.findDepartment(CurrentUserUtil.getCurrentUserId());
            if (Objects.nonNull(department)) {
                departmentId = department.getId();
