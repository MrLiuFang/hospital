        ...
        if (Objects.nonNull(userLastWashDto) && Objects.nonNull(userLastWashDto.getDateTime()) && Objects.nonNull(userLastWashDto.getUserId()) ) {
            ...
            if (Objects.nonNull(washEvent)) {
                ...
                if (optionalRegion.isPresent()) {
                    String cctvUrl = saveCctv(cctvExposeService.findRegionId(optionalRegion.get().getId()),washEvent.getDdt(),userLastWashDto.getDateTime().plusSeconds(userLastWashDto.getTime()));
