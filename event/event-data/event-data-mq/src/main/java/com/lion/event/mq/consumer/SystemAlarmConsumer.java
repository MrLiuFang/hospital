...
//                    }
            ...
            rocketMQTemplate.syncSend(TopicConstants.SAVE_CCTV_DELAY, MessageBuilder.withPayload(jacksonObjectMapper.writeValueAsString(newSystemAlarm)).build(),1000,10);
