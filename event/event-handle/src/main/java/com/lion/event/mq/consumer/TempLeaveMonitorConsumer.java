            ...
            if (Objects.nonNull(tempLeaveMonitorDto) && Objects.nonNull(tempLeaveMonitorDto.getDelayDateTime())) {
                ...
                if (millis <= 1000) {
                    ...
                    if ( Objects.nonNull(currentRegionDto)) {
                        Region patientRegion = redisUtil.getPatientRegion(tempLeaveMonitorDto.getPatientId());
                        if (Objects.equals(patientRegion.getId(),currentRegionDto.getRegionId())) {
                            patientExposeService.updatePatientState(tempLeaveMonitorDto.getPatientId(), PatientState.ABNORMAL_DEPARTURE);
                            return;
                        }
...
//                            if (Objects.equals(patientRegion.getRegionId(),currentRegionDto.getRegionId())) {
//                                return;
//                            }
//                        }
                    }
